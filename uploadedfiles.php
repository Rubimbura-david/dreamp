...
if (mysqli_num_rows($result) > 0) {
    echo '<table>';
    echo '<th>S/n</th><th>prodID</th><th>Category</th><th>Location</th><th>value</th><th>selectors</th>';
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $value = $row['value'];
        echo "<tr>";
        echo "<td>$id</td><td>$file</td><td>$category</td><td>$province, $district, $sector, $cell, $village</td><td>$value</td>";
        echo "<td><i class='fa-solid fa-trash'></i><i class='fa-solid fa-pen-to-square'></i><i class='fa-solid fa-location-dot'></i></td>";
        echo "</tr>";
    }
    echo '</table>';
} else {
