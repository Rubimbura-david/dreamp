        ...
        <div class="nav1">
            <div class="nav2">
             <select name="links" id="" size="1" onchange="window.location.href=this.value;"> 
                 <option value="property.php">House</option>
                 <option value="land.php">Land</option>
               </select>
            </div>
...
$query = "SELECT * FROM uploaded WHERE category='house'";
    ...
    <div class="container">
        ...
        <div class="footer-content">  
            <h3>follow us</h3><ul>
                ...
                <li><a href=""><i class="fa-brands fa-youtube"></i></a></li></ul>
    </div></div>
