...
if(isset($_POST['submit'])){
    ...
    $value=$_POST['value'];
    $query= "INSERT INTO uploaded(file,category,province,district,sector,cell,village,value) VALUES('$file', '$category', '$province','$district','$sector','$cell','$village','$value')";
   ...
   echo "Recorded successfully";
    ...
    <select class="select" name="category" required><option>land</option>
    ...
    <div class="butto"><button name="submit">send</button><button>reset</button>
    </form>
</div></div></div>
</body></html>
