...
if(isset($_POST['submit'])){
    ...
    $npass=$_POST['pass2'];
    $query= "INSERT INTO adminlogin(firstname,lastname,email,birthdate,sex,username,password) VALUES('$firstname', '$lastname', '$email','$birth','$radio','$username','$npass')";
   ...
   <p>username</p>
    ...
    <a href="adminlogin.php" style="font-size: 30px;color: brown;margin-left: 7%;">sign in</a>
</form>
 </div></div>
        <footer>
            <div class="container">
